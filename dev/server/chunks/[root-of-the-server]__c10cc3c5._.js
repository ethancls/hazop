...
"[project]/web/src/app/api/projects/[id]/nodes/route.ts [app-route] (ecmascript)", ((__turbopack_context__) => {
"use strict";
...
async function GET(request, { params }) {
    try {
        ...
        const project = await __TURBOPACK__imported__module__$5b$project$5d2f$web$2f$src$2f$lib$2f$db$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["default"].project.findFirst({
            where: {
                id: projectId,
                createdById: user.id
            }
        ...
        const nodes = await __TURBOPACK__imported__module__$5b$project$5d2f$web$2f$src$2f$lib$2f$db$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["default"].node.findMany({
            where: {
                projectId
            },
            include: {
...
async function POST(request, { params }) {
    try {
        ...
        const node = await __TURBOPACK__imported__module__$5b$project$5d2f$web$2f$src$2f$lib$2f$db$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["default"].node.create({
            data: {
                projectId,
                name,
...
//# sourceMappingURL=%5Broot-of-the-server%5D__c10cc3c5._.js.map