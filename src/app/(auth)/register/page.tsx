      ...
      <div className="relative hidden lg:block p-4">
        <div className="relative w-full h-full rounded-3xl overflow-hidden">
          ...
          <div className="absolute bottom-0 left-0 right-0 p-8">
            <h2 className="text-3xl font-bold text-white mb-3">Join HAZOP Labs</h2>
            <p className="text-white/80 text-lg max-w-md">
              Start conducting professional HAZOP studies today. 
              Collaborate with your team and ensure process safety compliance.
            </p>
          </div>
        </div>
      </div>
